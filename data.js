const groups = {
  ...
  2: [
    ...
    { name: "Armah Prince", index: "BSCIT/AS/30/25/0003", region: "ASHANTI" },
    { name: "Helena Tipogbil Yidaan", index: "BEMAT/AS/01/25/0002", region: "ASHANTI" },
    { name: "Ababio Eva Addai", index: "BEMAT/AS/30/25/0022", region: "ASHANTI" }
  ],
  3: [
  ...
  17: [
    ...
    { name: "AGONGO AYINE ELVIS", index: "CD/ITE/UE/30/25/0005", region: "UPPEREAST" }
  ],
  18: [
